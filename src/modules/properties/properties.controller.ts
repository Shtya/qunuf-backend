...
export class PropertiesController {
  ...
  @Post('bulk')
  @Auth(UserRole.ADMIN)
  @ApiOperation({ summary: 'Admin: Bulk create multiple properties at once (no file uploads)' })
  async bulkCreate(@User() user: any, @Body() dto: BulkCreatePropertyDto) {
    return this.propertiesService.bulkCreate(user.id, dto);
  }
  ...
  @ApiOperation({ summary: 'Landlord/Admin: Create new property (Sets to Pending)' })
  ...
  async getRecentProperties(
    ...
    return this.propertiesService.getRecentProperties(
      user,
